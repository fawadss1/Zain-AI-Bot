...
__all__ = [
    'DISPID_SVPause', 'DISPID_SASetState', 'ISpRecoContext',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SPRuleChildren', 'SPRULE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SRRTimes',
    'DISPID_SpeechPhoneConverter', 'SVP_13', 'DISPID_SGRSTsCount',
    'eLEXTYPE_PRIVATE17', 'SpeechAudioVolume',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SWFEBitsPerSample',
    'SSSPTRelativeToCurrentPosition', 'SGDSActive',
    'SpeechStreamSeekPositionType', 'SREInterference',
    'DISPID_SVGetAudioOutputs', 'SPSHORTCUTPAIR',
    'DISPID_SRRSetTextFeedback', 'SRTReSent', 'SPDKL_CurrentConfig',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPAsItem',
    'SWPUnknownWordPronounceable', 'DISPID_SVEViseme',
    'DISPID_SLWType', 'SpMMAudioEnum', 'WAVEFORMATEX',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SOTsItem',
    'Speech_Max_Word_Length', 'DISPID_SRDisplayUI',
    'SPEI_WORD_BOUNDARY', 'SAFTGSM610_44kHzMono', 'SGRSTTWord',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SAVolume',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SpeechGrammarRule',
    'SVSFPersistXML', 'SDTDisplayText', 'DISPID_SRGIsPronounceable',
    'SVEViseme', 'DISPID_SLWsItem', 'SP_VISEME_2',
    'SpeechRuleAttributes', 'SpeechPropertyAdaptationOn',
    'SREPrivate', 'SPVOICESTATUS', 'DISPID_SPISaveToMemory',
    'SPPS_Unknown', 'SAFTADPCM_22kHzMono', 'Speech_StreamPos_Asap',
    'SBONone', 'DISPID_SVEBookmark', 'SAFT44kHz8BitMono',
    'DISPID_SGRSTRule', 'SPCONTEXTSTATE', 'DISPID_SRGRules',
    'DISPID_SGRSAddWordTransition', 'DISPID_SpeechLexicon',
    'SpeechSpecialTransitionType', 'DISPID_SRGCmdSetRuleIdState',
    'SpeechVisemeType', 'SP_VISEME_17', 'ISpNotifyTranslator',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRCEPhraseStart',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SGRSAddRuleTransition',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRCRequestedUIType',
    'SPPS_LMA', 'DISPID_SLPType', 'SAFTADPCM_44kHzMono',
    'SPEI_PHONEME', 'DISPID_SPPConfidence', 'SpeechInterference',
    'SITooQuiet', 'SAFT22kHz8BitMono', 'STSF_AppData',
    'DISPID_SRAudioInputStream', 'DISPID_SRCEHypothesis',
    'DISPID_SGRSTransitions', 'SPWF_INPUT', 'SPADAPTATIONRELEVANCE',
    'SVEBookmark', 'SPINTERFERENCE_TOOLOUD', 'DISPID_SRGCommit',
    ...
    'SSFMCreateForWrite', 'SAFT24kHz8BitStereo',
    'DISPIDSPTSI_SelectionLength', 'SPGS_EXCLUSIVE',
    'DISPID_SpeechMemoryStream', 'DISPID_SRState', 'SVEVoiceChange',
    'DISPID_SVEStreamStart', 'DISPID_SGRId', 'DISPID_SGRSTPropertyId',
    'eLEXTYPE_PRIVATE3', 'SAFT12kHz16BitMono', 'DISPID_SPPsItem',
    'ISpeechPhraseReplacements', 'SPINTERFERENCE_LATENCY_WARNING',
    'eWORDTYPE_ADDED', 'DISPID_SDKDeleteKey', 'SDKLDefaultLocation',
    'SPEI_MAX_SR', 'SSFMOpenForRead', 'ISpeechGrammarRule',
    'DISPID_SGRInitialState', 'SP_VISEME_15', 'DISPID_SPPParent',
    'DISPID_SPRuleParent', 'SPWT_DISPLAY', 'ISpeechPhoneConverter',
    'SGRSTTWildcard', 'DISPID_SLPPartOfSpeech',
    'DISPID_SOTCGetDataKey', 'SVPNormal',
    'DISPID_SpeechPhraseProperties', 'SPSLMA', 'SpeechTokenKeyUI',
    'DISPID_SPRuleEngineConfidence', 'SASStop', 'SPEI_ADAPTATION',
    'DISPID_SGRsAdd', 'DISPID_SAFGuid', 'SpeechGrammarTagWildcard',
    'SPPS_Function', 'ISpObjectWithToken', 'SpeechAudioState',
    'DISPID_SPIGetText', 'DISPID_SGRSTWeight',
    'DISPID_SVAlertBoundary', 'SPSNotOverriden', 'SPSFunction',
    'eLEXTYPE_PRIVATE16', 'ISpEventSink', 'SP_VISEME_3',
    'DISPID_SDKGetBinaryValue', 'ISpeechRecoResult',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SABIEventBias',
    'DISPID_SVESentenceBoundary', 'SPEI_RESERVED5',
    'DISPID_SWFEFormatTag', 'SPEI_TTS_PRIVATE',
    'DISPID_SRRSpeakAudio', 'SpeechEmulationCompareFlags',
    'SPDKL_CurrentUser', 'DISPID_SPIAudioSizeTime',
    'SPEI_VOICE_CHANGE', 'SP_VISEME_21', 'ISpAudio', 'SVP_4',
    'SVEAudioLevel', 'DISPID_SRProfile', 'DISPID_SRCPause',
    'DISPID_SpeechRecognizer', 'SSSPTRelativeToEnd', 'SRTStandard',
    'DISPID_SPEsCount', 'DISPID_SVEEnginePrivate', 'DISPID_SRGState',
    'ISpPhraseAlt', 'DISPID_SVEWord', 'DISPID_SOTRemove',
    'DISPID_SVStatus', 'SVEWordBoundary',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SPPsCount', 'DISPID_SRCERecognition', 'SWTDeleted',
    'DISPID_SpeechBaseStream', 'DISPID_SRCEAdaptation',
    'DISPID_SPERetainedSizeBytes', 'ISpeechObjectTokenCategory',
    'SVP_15', 'DISPID_SLGetGenerationChange', 'ISpPhoneConverter',
    'SpStreamFormatConverter', 'SASClosed', 'SVSFNLPMask',
    'DISPIDSPTSI_ActiveLength', 'SDTProperty', 'SAFTADPCM_8kHzStereo',
    'DISPID_SREmulateRecognition', 'SPRST_INACTIVE',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SRGRecoContext', 'SPSNoun',
    'DISPID_SPPId', 'DISPID_SGRsCount', 'SECFNoSpecialChars',
    'SPEI_END_SR_STREAM', 'SAFTExtendedAudioFormat',
    'ISpPhoneticAlphabetSelection', 'eLEXTYPE_PRIVATE9', 'SVPAlert',
    'SPFM_OPEN_READWRITE', 'DISPID_SDKSetBinaryValue',
    'DISPID_SVSLastStreamNumberQueued', 'SPAR_High', 'SP_VISEME_7',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SP_VISEME_10',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'ISpeechPhraseRule',
    'DISPID_SpeechPhraseRule', 'SPRS_ACTIVE', 'DISPID_SpeechDataKey',
    'DISPID_SPILanguageId', 'DISPID_SGRSTNextState',
    'SPEVENTSOURCEINFO', 'DISPID_SpeechObjectToken',
    'SAFT16kHz8BitStereo', 'SPLO_STATIC',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'eLEXTYPE_PRIVATE4',
    'SAFT12kHz8BitStereo', 'SPSTREAMFORMATTYPE',
    'DISPID_SOTGetAttribute', 'SVSFNLPSpeakPunc',
    'DISPID_SPIReplacements', 'DISPID_SVEStreamEnd', 'SRERecognition',
    'SPINTERFERENCE', 'SGRSTTDictation', 'SRATopLevel',
    'SPCT_DICTATION', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SDKCreateKey', 'ISpeechObjectTokens', 'SFTInput',
    'SSTTTextBuffer', 'SGRSTTRule', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRCEPropertyNumberChange', 'SVP_21', 'ISpeechLexiconWord',
    'DISPID_SRCVoicePurgeEvent', 'SPEI_VISEME', 'SpSharedRecoContext',
    'ISpeechGrammarRules', 'DISPID_SpeechAudio', 'DISPID_SLPsCount',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SRGCmdLoadFromObject', 'SPPS_Noun',
    'SPEI_END_INPUT_STREAM', 'SpShortcut', 'ISpeechVoice',
    'SDA_Consume_Leading_Spaces', 'SVP_2', 'SVESentenceBoundary',
    'SPPHRASEREPLACEMENT', 'SAFT16kHz16BitStereo', 'SPCATEGORYTYPE',
    'ISpStreamFormatConverter', 'SVEStartInputStream',
    'DISPID_SOTCSetId', 'DISPID_SOTDisplayUI',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPRules_NewEnum',
    'SAFT22kHz16BitStereo', 'SAFT44kHz8BitStereo', 'SPVPRI_OVER',
    'ISpeechAudioFormat', 'SpeechCategoryRecoProfiles',
    'SP_VISEME_12', 'SAFTNonStandardFormat',
    'DISPID_SpeechRecognizerStatus',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechPropertyResponseSpeed', 'SDTAudio',
    'DISPID_SPEPronunciation', 'SP_VISEME_9', 'SPEI_SOUND_END',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SFSClose',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPRS_INACTIVE',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SDKDeleteValue',
    'DISPID_SPARecoResult', 'DISPID_SPEs_NewEnum',
    'SpeechCategoryRecognizers', 'DISPID_SPIGrammarId', 'SRAExport',
    'DISPID_SPIRule', 'SDTAlternates', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRCEFalseRecognition', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SPRuleConfidence', 'DISPID_SpeechFileStream',
    'SRERecoOtherContext', 'SPSHT_OTHER', 'SGDisplay',
    'SPSHT_Unknown', 'SPPHRASE', 'SpFileStream', 'SP_VISEME_4',
    'DISPID_SPRNumberOfElements', 'SPWORDPRONOUNCEABLE',
    'SGLexicalNoSpecialChars', 'SDTReplacement',
    'DISPID_SPRuleNumberOfElements', 'eLEXTYPE_RESERVED9',
    'SECFDefault', 'DISPID_SRGReset', 'STSF_CommonAppData',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SRRAlternates', 'SVP_18',
    'SDA_Two_Trailing_Spaces', 'SVP_6', 'SPDATAKEYLOCATION',
    'DISPID_SLGenerationId', 'SPINTERFERENCE_TOOQUIET',
    'SpeechGrammarRuleStateTransitionType', 'SLTUser', 'SPWORDTYPE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechVoiceSkipTypeSentence', 'SPEVENTENUM',
    ...
    'SAFTCCITT_ALaw_22kHzMono', 'SDTAll', 'SP_VISEME_8',
    'DISPID_SRGetRecognizers', 'SRERequestUI', 'STCInprocHandler',
    'DISPID_SGRsCommit', 'SPEI_SENTENCE_BOUNDARY', 'SPFM_CREATE',
    'SpeechCategoryPhoneConverters', 'DISPID_SpeechAudioBufferInfo',
    'SPBO_NONE', 'SPEVENT', 'DISPID_SDKSetStringValue',
    'DISPID_SPRsCount', 'SpeechRecoContextState',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SGRAddResource',
    'SRESoundStart', 'SPBO_AHEAD', 'SPPS_RESERVED3', 'SP_VISEME_13',
    'DISPID_SMSALineId', 'ISpNotifySink', 'SSTTWildcard',
    'SPRECOCONTEXTSTATUS', 'SAFT32kHz16BitStereo', 'SPPS_RESERVED2',
    'SGDSInactive', 'SRSActiveAlways', 'DISPID_SVSLastBookmarkId',
    'eLEXTYPE_RESERVED8', 'DISPID_SMSSetData', 'SVP_14',
    'SREStreamEnd', 'SPXRO_Alternates_SML',
    'DISPID_SLAddPronunciation', 'DISPID_SABufferNotifySize',
    'SVEPrivate', 'SVSFDefault', 'DISPID_SRStatus', 'ISpProperties',
    'DISPID_SRRSaveToMemory', 'SPPS_RESERVED1',
    'IInternetSecurityManager', 'SREBookmark', 'STSF_LocalAppData',
    'DISPID_SRCEPropertyStringChange', 'SpeechGrammarState',
    'eLEXTYPE_PRIVATE19', 'DISPID_SOTs_NewEnum',
    'DISPID_SRAudioInput', 'DISPID_SPPFirstElement',
    'SGPronounciation', 'SpPhoneticAlphabetConverter',
    'SpObjectTokenCategory', 'ISpeechXMLRecoResult',
    'SAFT8kHz16BitStereo', 'STCRemoteServer', 'DISPID_SRSAudioStatus',
    'DISPID_SRRGetXMLResult', 'SPRST_INACTIVE_WITH_PURGE',
    'SRAImport', 'SpeechWordType', 'SpUnCompressedLexicon',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPIProperties',
    'DISPID_SADefaultFormat', 'SSFMOpenReadWrite', 'SPPHRASEPROPERTY',
    'SPPS_Modifier', 'SVSFVoiceMask', 'eLEXTYPE_PRIVATE12', 'SINone',
    'DISPID_SRCCreateResultFromMemory', 'SpMMAudioOut',
    'SpeechDataKeyLocation', 'DISPID_SpeechPhraseProperty',
    'SPEI_RESERVED6', 'DISPID_SRSNumberOfActiveRules', 'SPAUDIOSTATE',
    'SPEI_RECOGNITION', 'SVP_9', 'SGSExclusive',
    'DISPID_SVSRunningState', 'SDTLexicalForm',
    'SDA_No_Trailing_Space', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SLWPronunciations',
    'SpInProcRecoContext', 'SVSFlagsAsync', 'DISPID_SRRAudio',
    ...
    'DISPID_SVGetAudioInputs', 'SPGS_ENABLED', 'SAFTDefault',
    'DISPID_SGRsCommitAndSave', 'DISPID_SRGetPropertyNumber',
    'SASRun', 'ISpGrammarBuilder', 'SPEI_RECO_OTHER_CONTEXT',
    '_ISpeechRecoContextEvents', 'DISPID_SRCreateRecoContext',
    'DISPID_SPIEngineId', 'SRARoot', 'eLEXTYPE_RESERVED4',
    'DISPID_SRCEEnginePrivate', 'SRADynamic', 'eLEXTYPE_PRIVATE5',
    'DISPID_SGRs_NewEnum', 'SPDKL_LocalMachine', 'SPWAVEFORMATTYPE',
    'SPBOOKMARKOPTIONS', 'SVSFParseMask', 'DISPID_SPEDisplayText',
    'SDTRule', 'SAFTCCITT_ALaw_8kHzStereo', 'SVP_11',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SGDSActiveWithAutoPause', 'DISPID_SAFGetWaveFormatEx',
    'SpObjectToken', 'DISPID_SRGCmdLoadFromFile', 'SITooFast',
    'SPGRAMMARSTATE', 'SSTTDictation', 'SREPropertyNumChange',
    'SAFTCCITT_uLaw_22kHzMono', 'SRCS_Enabled', 'SAFTGSM610_8kHzMono',
    '_ISpeechVoiceEvents', 'DISPID_SDKGetlongValue',
    'ISpeechFileStream', 'SAFT22kHz8BitStereo', 'DISPID_SLWWord',
    'SLOStatic', 'DISPID_SPRuleName', 'SpeechAudioProperties',
    'eLEXTYPE_PRIVATE15', 'DISPID_SGRSTsItem',
    'SpeechPropertyComplexResponseSpeed', '_SPAUDIOSTATE',
    'DISPID_SLPPhoneIds', 'ISpObjectToken', 'SPWORD',
    'DISPID_SBSRead', 'SRTExtendableParse',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SpeechObjectTokenCategory', 'SAFT32kHz16BitMono',
    'DISPID_SMSAMMHandle', 'SPFM_NUM_MODES', 'DISPID_SVIsUISupported',
    'SREHypothesis', 'DISPID_SRGCmdSetRuleState',
    'SAFT16kHz16BitMono', 'SPRST_NUM_STATES', 'SPSMF_UPS',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPPName', 'SVP_16',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRRPhraseInfo',
    'SRAInterpreter', 'SPFM_CREATE_ALWAYS', 'SPAR_Unknown',
    'DISPID_SLPSymbolic', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRCEStartStream', 'DISPID_SPRFirstElement',
    'SREFalseRecognition', 'SpeechTokenShellFolder',
    'SAFT48kHz16BitStereo', 'DISPID_SGRSTText',
    'SpeechEngineConfidence', 'DISPID_SRCCreateGrammar',
    'SPAUDIOSTATUS', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SRSetPropertyString', 'SPSSuppressWord', 'ISpShortcut',
    'DISPID_SOTGetStorageFileName', 'eLEXTYPE_RESERVED6',
    'SPINTERFERENCE_TOOFAST', 'SRSEIsSpeaking',
    'DISPID_SpeechPhraseElements', 'DISPID_SVSInputWordPosition',
    'SpeechTokenKeyAttributes', 'SpeechVoiceCategoryTTSRate',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRCVoice',
    'SpPhraseInfoBuilder', 'SINoSignal', 'SPAS_STOP',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SGRSAddSpecialTransition',
    'ISpRecoContext2', 'SVPOver', 'SAFT44kHz16BitMono', 'SPAO_NONE',
    'IInternetSecurityMgrSite', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SLWs_NewEnum', 'SAFTADPCM_22kHzStereo',
    'DISPID_SLGetWords', 'DISPID_SpeechAudioFormat',
    'DISPID_SPAsCount', 'ISpObjectTokenCategory', 'SpVoice',
    'ISpeechResourceLoader', 'DISPID_SPEActualConfidence',
    'SPAR_Medium', 'SPPS_SuppressWord', 'SAFTCCITT_uLaw_44kHzMono',
    'SPLOADOPTIONS', 'SpResourceManager', 'DISPID_SPCPhoneToId',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SRIsShared',
    'SpeechGrammarTagUnlimitedDictation', 'tagSPPROPERTYINFO',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPIDSPRG',
    'SPWORDLIST', 'SPSMF_SAPI_PROPERTIES',
    ...
    'SPVPRI_NORMAL', 'DISPID_SGRName', 'SpeechRunState',
    'DISPID_SpeechRecoResult', 'DISPID_SVRate', 'IEnumSpObjectTokens',
    'SVEAllEvents', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechMMSysAudio', 'SAFT8kHz16BitMono', 'SPSUnknown',
    'SPRECOGNIZERSTATUS', 'DISPID_SLGetPronunciations',
    'DISPID_SGRSTType', 'SPSEMANTICERRORINFO', 'SpNullPhoneConverter',
    'SpeechAudioFormatType', 'DISPID_SPIAudioStreamPosition',
    'eLEXTYPE_PRIVATE7', 'SAFTNoAssignedFormat',
    'SpeechAudioFormatGUIDText', 'Speech_Default_Weight',
    'DISPID_SVSpeakCompleteEvent', 'SECNormalConfidence',
    'SpeechVoiceSpeakFlags', 'SpTextSelectionInformation',
    'SRTSMLTimeout', 'SPAR_Low', 'SPCT_SLEEP',
    'DISPID_SPERetainedStreamOffset', 'SREAllEvents',
    'DISPID_SPPChildren', 'eLEXTYPE_PRIVATE13', 'DISPID_SPRsItem',
    'DISPID_SPACommit', 'DISPID_SPPs_NewEnum', 'SPPS_NotOverriden',
    'DISPID_SVAudioOutput', 'SPFILEMODE', 'SAFT48kHz8BitMono',
    'SAFTADPCM_8kHzMono', 'tagSPTEXTSELECTIONINFO', 'SECFIgnoreWidth',
    'SPVPRIORITY', 'SPAO_RETAIN_AUDIO', 'SPPROPERTYINFO', 'SPAS_RUN',
    'SAFTText', 'SPCT_SUB_DICTATION', 'SpeechDisplayAttributes',
    'SVSFParseAutodetect', 'SAFT8kHz8BitStereo', 'ISpeechRecoContext',
    'SPSModifier', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPRulesItem', 'ISpeechGrammarRuleStateTransition',
    'SpeechVoicePriority', 'SVP_5', 'SPSEMANTICFORMAT',
    'SpeechDictationTopicSpelling', 'SpMemoryStream',
    'SDTPronunciation', 'SECFIgnoreCase', 'DISPID_SRRecognizer',
    'SRAONone', 'DISPID_SRGDictationLoad', 'DISPID_SGRAddState',
    'eLEXTYPE_PRIVATE18', 'SGSEnabled', 'DISPID_SPCIdToPhone',
    'SPVPRI_ALERT', 'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SGRSRule',
    'DISPID_SASFreeBufferSpace', 'SpeechAllElements',
    'ISpeechBaseStream', 'DISPID_SPEsItem',
    'SpeechTokenIdUserLexicon', 'SpeechRecoEvents',
    'DISPID_SRRRecoContext', 'SpeechVisemeFeature',
    'DISPID_SRCERecognizerStateChange', 'SAFT8kHz8BitMono',
    'SP_VISEME_16', 'DISPID_SRIsUISupported', 'SPBO_TIME_UNITS',
    'DISPID_SPAs_NewEnum', 'SPEI_SR_RETAINEDAUDIO',
    'eLEXTYPE_PRIVATE14', 'SP_VISEME_1', 'DISPID_SOTDataKey',
    'SPSHORTCUTTYPE', 'SVSFIsNotXML', 'DISPID_SRGId',
    'SVSFUnusedFlags', 'DISPID_SVVoice', 'SPSHORTCUTPAIRLIST',
    'SpeechRecognizerState', 'ISpeechPhraseElement',
    'DISPID_SRSClsidEngine', 'SSSPTRelativeToStart', 'SASPause',
    'SVEEndInputStream', 'ISpeechLexiconPronunciations',
    'ISpRecognizer2', 'SpAudioFormat', 'SpeechCategoryAudioIn',
    'SPRECOSTATE', 'SpWaveFormatEx', 'SVSFIsXML', 'DISPID_SPRuleId',
    'SVP_17', 'DISPID_SRRTTickCount', 'SVSFParseSsml',
    'SpeechUserTraining', 'DISPID_SRCESoundEnd', 'ISpSerializeState',
    'SECFEmulateResult', 'SAFT11kHz16BitStereo', 'SREAdaptation',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SVResume',
    'SpeechEngineProperties', 'SAFT24kHz16BitStereo',
    'SPSInterjection', 'DISPID_SDKEnumValues', 'DISPID_SBSFormat',
    'ISpeechAudioStatus', 'DISPID_SRGetFormat',
    'DISPID_SVEventInterests', 'ISpeechPhraseProperties',
    'SAFT12kHz8BitMono', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SRSSupportedLanguages', 'SPWORDPRONUNCIATION',
    'DISPID_SRCSetAdaptationData', 'SPWF_SRENGINE',
    'DISPID_SABIMinNotification', 'SPCT_SUB_COMMAND', 'SRTAutopause',
    'SDKLCurrentUser', 'ISpeechTextSelectionInformation',
    'eLEXTYPE_PRIVATE6', 'DISPID_SGRsItem', 'SpMMAudioIn',
    'DISPID_SPPValue', 'SAFT12kHz16BitStereo', 'SPBO_PAUSE',
    'DISPID_SPANumberOfElementsInResult', 'SAFTADPCM_44kHzStereo',
    'DISPID_SDKSetLongValue', 'SITooSlow', 'SRCS_Disabled',
    'DISPID_SRGDictationSetState', 'DISPID_SASState',
    'SPEI_SOUND_START', 'SPEI_RECO_STATE_CHANGE', 'SGRSTTEpsilon',
    'SPAS_CLOSED', 'DISPID_SABufferInfo', 'SpLexicon',
    'ISpNotifySource', 'DISPID_SRCBookmark', 'DISPID_SRCERequestUI',
    'SPBINARYGRAMMAR', 'ISpeechDataKey', 'SPPS_Noncontent',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SGRSTPropertyName',
    'SPRULESTATE', 'STCAll', 'DISPID_SpeechRecoContext', 'SVEPhoneme',
    'SECFIgnoreKanaType', 'ISpeechAudio', 'DISPID_SBSWrite',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPPS_Interjection',
    'SPWT_PRONUNCIATION', 'eLEXTYPE_PRIVATE11', 'DISPID_SVPriority',
    'DISPID_SWFESamplesPerSec', 'SPEI_SR_AUDIO_LEVEL',
    'SpeechRuleState', 'DISPID_SRCERecognitionForOtherContext',
    'SpeechCategoryVoices', 'ISpeechAudioBufferInfo',
    'Speech_StreamPos_RealTime', 'SRSEDone', 'ISpMMSysAudio',
    'DISPID_SAEventHandle', 'eLEXTYPE_PRIVATE1',
    'DISPID_SpeechObjectTokens', 'eLEXTYPE_USER_SHORTCUT',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SDKOpenKey',
    'ISpStreamFormat', 'DISPID_SOTRemoveStorageFileName', 'SWTAdded',
    'SREStreamStart', 'SPCS_DISABLED', 'SPRST_ACTIVE',
    'SPEI_TTS_BOOKMARK', 'DISPIDSPTSI_ActiveOffset',
    'SPFM_OPEN_READONLY', 'SpeechTokenValueCLSID', 'SP_VISEME_20',
    'SGSDisabled', 'SAFT11kHz8BitStereo', 'SPEI_INTERFERENCE',
    'DISPIDSPTSI', 'DISPID_SpeechPhraseBuilder', 'SpeechLexiconType',
    'DISPID_SRGDictationUnload', 'ISequentialStream',
    'DISPID_SpeechLexiconWord', 'DISPID_SVSInputWordLength',
    'eLEXTYPE_RESERVED10', 'SPWT_LEXICAL', 'SP_VISEME_14',
    'SpeechStreamFileMode', 'SAFT16kHz8BitMono', 'ISpeechMMSysAudio',
    'SP_VISEME_19', 'SpeechGrammarTagDictation', 'STSF_FlagCreate',
    'ISpeechRecoResultDispatch', 'SpStream', 'SpNotifyTranslator',
    'DISPID_SAFType', 'SPLEXICONTYPE', 'SAFT32kHz8BitMono',
    'ISpeechMemoryStream', 'SPINTERFERENCE_NOISE',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRCEEndStream',
    'eLEXTYPE_PRIVATE8', 'DISPID_SOTCDefault', 'STCInprocServer',
    'DISPID_SpeechRecoResult2', 'SpeechRecognitionType',
    'SpeechGrammarWordType', 'DISPID_SLPLangId',
    'DISPID_SVEVoiceChange', 'SRSInactiveWithPurge',
    ...
    'SPEI_RESERVED1', 'ISpEventSource', 'SRSInactive',
    'DISPID_SVEPhoneme', 'SVF_Emphasis', 'SAFT24kHz8BitMono',
    'DISPID_SOTMatchesAttributes', 'SVP_19',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPGS_DISABLED',
    'SAFT24kHz16BitMono', 'DISPID_SRGSetWordSequenceData',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRCResume', 'STCLocalServer',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SGRAttributes',
    'DISPID_SVSPhonemeId', 'ISpRecoGrammar2', 'ISpStream',
    'SSFMCreate', 'SAFTGSM610_11kHzMono', 'SpeechAudioFormatGUIDWave',
    'SPEI_MIN_SR', 'DISPID_SRRAudioFormat',
    'SAFTCCITT_ALaw_22kHzStereo', 'eWORDTYPE_DELETED',
    'SpeechAddRemoveWord', 'SPEI_SR_PRIVATE',
    'ISpeechLexiconPronunciation', 'eLEXTYPE_PRIVATE2',
    'DISPID_SPAStartElementInResult', 'DISPID_SpeechLexiconProns',
    'SVP_1', 'DISPID_SPEEngineConfidence', 'DISPID_SBSSeek',
    'DISPID_SpeechPhraseReplacement', 'ISpeechPhraseRules',
    'DISPID_SWFEBlockAlign', 'DISPID_SVDisplayUI', 'SGRSTTTextBuffer',
    'SpeechFormatType', 'tagSTATSTG', 'DISPID_SRCESoundStart',
    'SPAUDIOOPTIONS', 'SAFT48kHz8BitStereo', 'SPTEXTSELECTIONINFO',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpeechMicTraining',
    'Speech_Max_Pron_Length', 'DISPID_SVSLastBookmark',
    'SPEI_UNDEFINED', 'SPEI_MAX_TTS', 'DISPID_SPERequiredConfidence',
    'eLEXTYPE_RESERVED7', 'ISpeechGrammarRuleState',
    'ISpeechPhraseInfoBuilder', 'SPSHT_EMAIL', 'SPEI_PHRASE_START',
    'SECLowConfidence', 'SBOPause', 'SRAORetainAudio',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRCEInterference',
    '__MIDL_IWinTypes_0009', 'SPSERIALIZEDPHRASE',
    'SPXMLRESULTOPTIONS', 'DISPID_SDKGetStringValue',
    'SPAUDIOBUFFERINFO', 'SLTApp', 'DISPID_SPRs_NewEnum',
    ...
    'DISPID_SGRClear', 'SPGRAMMARWORDTYPE', 'SPSHT_NotOverriden',
    'DISPID_SMSGetData', 'SpeechDiscardType', 'SpSharedRecognizer',
    'SpeechLoadOption', 'ISpPhoneticAlphabetConverter',
    'DISPID_SWFEChannels', 'DISPID_SVVolume', 'DISPID_SPIElements',
    'SPPHRASERULE', 'SVP_12', 'ISpRecoGrammar', 'ISpeechRecoResult2',
    'DISPID_SRCRetainedAudio', 'SINoise', 'DISPID_SFSOpen',
    'DISPID_SVAudioOutputStream', 'SPRECORESULTTIMES',
    'SDA_One_Trailing_Space', 'ISpeechLexicon', 'IEnumString',
    'SAFT22kHz16BitMono', 'SPLO_DYNAMIC', 'SVP_0',
    'DISPID_SRRGetXMLErrorInfo', 'SpCompressedLexicon',
    'SRADefaultToActive', 'SVF_Stressed', 'DISPID_SPEAudioSizeBytes',
    'SVSFPurgeBeforeSpeak', 'DISPID_SOTSetId', 'SP_VISEME_11',
    'ISpeechPhraseInfo', 'DISPID_SGRsFindRule',
    'DISPID_SpeechCustomStream', 'DISPID_SVEAudioLevel',
    'DISPID_SVSpeakStream', 'DISPID_SRCState', 'ISpRecoCategory',
    'DISPID_SRCRetainedAudioFormat', 'ISpeechPhraseReplacement',
    'DISPID_SOTId', 'SAFT11kHz8BitMono', 'DISPID_SGRsDynamic',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SPRuleFirstElement', 'SVSFParseSapi',
    'DISPID_SVGetProfiles', 'SpPhoneConverter', 'SPEI_HYPOTHESIS',
    'DISPID_SMSADeviceId', 'IStream', 'DISPID_SVGetVoices',
    'SPEI_RESERVED3', 'DISPID_SCSBaseStream', 'SVP_7',
    'DISPID_SPRText', 'DISPID_SPPNumberOfElements',
    'DISPID_SVSLastResult', 'SPINTERFERENCE_NONE', 'SPEI_SR_BOOKMARK',
    'SP_VISEME_6', 'DISPID_SpeechPhraseAlternate',
    ...
    'SPPS_Verb', 'SAFT32kHz8BitStereo', 'DISPID_SOTCreateInstance',
    'ISpeechRecognizer', 'SP_VISEME_0', 'SpInprocRecognizer',
    'DISPID_SOTCId', 'DISPID_SpeechPhraseRules', 'ISpVoice', 'SVP_3',
    'SPEI_MIN_TTS', 'ISpXMLRecoResult', 'SpeechBookmarkOptions',
    'ISpRecognizer', 'DISPID_SPELexicalForm', 'ISpeechPhraseProperty',
    'ISpeechObjectToken', 'DISPID_SWFEAvgBytesPerSec',
    'ISpRecognizer3', 'SRSActive', 'ISpPhrase',
    'DISPID_SRGetPropertyString', 'eLEXTYPE_VENDORLEXICON',
    'ISpeechPhraseAlternates', 'ISpeechPhraseElements',
    'SREAudioLevel', 'DISPID_SOTIsUISupported', 'SPVISEMES',
    'SITooLoud', 'SpeechPropertyHighConfidenceThreshold',
    'eLEXTYPE_APP', 'SDKLCurrentConfig', 'SAFT44kHz16BitStereo',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SpeechPhraseElement', 'SAFTADPCM_11kHzMono',
    'SpeechCategoryAudioOut', 'LONG_PTR',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SRCEAudioLevel',
    'SPCT_COMMAND', 'DISPID_SpeechVoiceEvent', 'SLODynamic',
    'DISPID_SOTCategory', 'ISpeechPhraseAlternate',
    'DISPID_SDKEnumKeys', 'SP_VISEME_18', 'SRESoundEnd',
    'DISPID_SRRTLength', 'SECHighConfidence', 'SREStateChange',
    'DISPID_SRCEventInterests', 'SGLexical',
    'DISPID_SOTGetDescription', 'SPPHRASEELEMENT', 'SPPARTOFSPEECH',
    'SpeechVoiceEvents', 'SAFTGSM610_22kHzMono', 'SVF_None',
    'ISpeechRecoGrammar', 'DISPID_SPAPhraseInfo',
    'DISPID_SLPs_NewEnum', 'SDKLLocalMachine', 'SVP_20',
    'DISPID_SpeechAudioStatus', 'SVP_10', 'UINT_PTR',
    'DISPID_SLWLangId', 'SpCustomStream',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpeechWaveFormatEx', 'SVP_8',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRGSetTextSelection',
    'DISPID_SAStatus', 'SREPropertyStringChange', 'ISpRecoResult',
    'SpeechRegistryUserRoot', 'DISPID_SRRTStreamTime', 'SPAS_PAUSE',
    'DISPID_SOTsCount', 'SPXRO_SML', 'eLEXTYPE_PRIVATE10',
    'DISPID_SGRSTPropertyValue', 'SPEI_REQUEST_UI', 'SPEI_RESERVED2',
    ...
    'SPCS_ENABLED', 'SpeechWordPronounceable',
    'SGDSActiveUserDelimited', 'DISPID_SPIStartTime', 'ISpLexicon',
    'DISPID_SASNonBlockingIO', 'ISpeechLexiconWords',
    'DISPID_SABIBufferSize', 'SRTEmulated', 'SFTSREngine',
    '_RemotableHandle', 'ISpResourceManager', 'DISPID_SRCRecognizer',
    'SPSERIALIZEDRESULT', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SVSkip', 'SP_VISEME_5', 'SWPKnownWordPronounceable',
    'ISpeechRecognizerStatus', 'SpeechTokenKeyFiles'
]

_check_version('1.1.14', 1617976183.192473)
